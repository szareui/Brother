...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgUploadBegin: 'انتظار ...',
        msgUploadEnd: 'تمام',
        msgUploadEmpty: 'No valid data available for upload.',
        msgValidationError: 'Validation Error',
        msgLoading: 'در حال بارگزاری {index} از {files} &hellip;',
        msgProgress: 'در حال بارگزاری {index} از {files} - {name} - {percent}% کامل شد.',
        ...
        dropZoneTitle: 'فایل خود را اینجا بکشید و رها کنید &hellip;',
